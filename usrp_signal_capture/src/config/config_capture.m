...
%CONFIG_CAPTURE Configuration for PPT + X310 batch capture.
    ...
    cfg.general.pause_between_attempts_s = 0.6;

    % Pause right before formal capture
    cfg.general.pause_before_capture_s = 0.8;
    ...
    % =========================================================
    cfg.sdr.pause_after_rx_create_s = 0.8;
    cfg.sdr.pause_before_rx_recreate_s = 0.8;

    % Ordinary fail threshold
    cfg.sdr.fail_recreate_threshold = 2;
...
endfunction cfg = config_capture()
%CONFIG_CAPTURE Configuration for PPT + X310 batch capture.
